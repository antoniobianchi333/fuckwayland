...
including 26.04's `-proposed` pair and the GA library under a newer shell — so an ordinary update is not what this breaks
on; a release upgrade is, and there it refuses at `shell-version`
([docs/WXRANDR.md § What ordinary updates actually do](../docs/WXRANDR.md#what-ordinary-updates-actually-do)).
