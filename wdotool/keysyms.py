...
Regenerate with the script quoted below (network needed only then):
    ...
    def main(path):
        ...
        w("X keysym tables parsed from xorgproto include/X11/keysymdef.h.\n")
